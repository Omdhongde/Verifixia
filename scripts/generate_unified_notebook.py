...
def generate_unified_notebook():
    print("Generating unified Deepfake_Model_Training.ipynb...")
    
    # 38-epoch Image model training history
    img_train_loss = [0.8040, 0.7771, 0.7405, 0.6729, 0.6695, 0.6553, 0.5988, 0.5700, 0.5301, 0.4692, 
                      0.3700, 0.3439, 0.2972, 0.2790, 0.1908, 0.1165, 0.0709, 0.0410, 0.0210, 0.0148, 
                      0.0205, 0.0385, 0.0227, 0.0122, 0.0087, 0.0123, 0.0128, 0.0076, 0.0152, 0.0118, 
                      0.0094, 0.0051, 0.0067, 0.0044, 0.0041, 0.0047, 0.0058, 0.0032]
    img_train_acc = [0.5200, 0.5488, 0.5863, 0.6250, 0.6350, 0.6475, 0.7213, 0.7225, 0.7575, 0.7775, 
                     0.8350, 0.8388, 0.8663, 0.8825, 0.9275, 0.9663, 0.9813, 0.9913, 0.9988, 0.9988, 
                     0.9963, 0.9888, 0.9950, 0.9988, 1.0000, 0.9963, 0.9963, 0.9988, 0.9950, 0.9988, 
                     1.0000, 1.0000, 0.9988, 1.0000, 1.0000, 1.0000, 0.9988, 1.0000]
    img_val_loss = [3.1766, 1.7476, 0.6822, 0.6864, 0.7017, 0.6605, 0.6128, 0.7053, 0.6234, 0.6483, 
                    0.7599, 0.6542, 0.8090, 0.7355, 0.7378, 0.7092, 0.6353, 0.6978, 0.6956, 0.7112, 
                    0.7693, 0.7907, 0.7981, 0.7917, 0.7933, 0.8625, 0.8202, 0.8297, 0.8385, 0.8762, 
                    0.8004, 0.8283, 0.7805, 0.7695, 0.7749, 0.7763, 0.7984, 0.8061]
    img_val_acc = [0.5200, 0.5750, 0.5750, 0.5650, 0.6050, 0.6150, 0.6550, 0.6300, 0.6400, 0.6500, 
                   0.6800, 0.6900, 0.6550, 0.7050, 0.7200, 0.7200, 0.7250, 0.7150, 0.7400, 0.7300, 
                   0.7250, 0.7300, 0.7450, 0.7300, 0.7450, 0.7250, 0.7350, 0.7300, 0.7300, 0.7500, 
                   0.7250, 0.7350, 0.7300, 0.7300, 0.7350, 0.7350, 0.7150, 0.7150]
    img_val_f1 = [0.2000, 0.6444, 0.6444, 0.6329, 0.6638, 0.5698, 0.5430, 0.6300, 0.6636, 0.6569, 
                  0.6559, 0.6702, 0.6567, 0.6509, 0.6500, 0.7200, 0.7179, 0.7192, 0.7111, 0.7065, 
                  0.7027, 0.7158, 0.6982, 0.7065, 0.7151, 0.6995, 0.7196, 0.7245, 0.7128, 0.7191, 
                  0.7059, 0.7135, 0.7065, 0.7158, 0.7104, 0.7196, 0.6919, 0.6952]
    img_val_auc = [0.4825, 0.5802, 0.6487, 0.6307, 0.6727, 0.6616, 0.7362, 0.6933, 0.7147, 0.7426, 
                   0.7608, 0.7721, 0.7669, 0.7844, 0.7989, 0.8134, 0.8262, 0.8307, 0.8328, 0.8320, 
                   0.8385, 0.8221, 0.8333, 0.8363, 0.8354, 0.8262, 0.8342, 0.8304, 0.8325, 0.8226, 
                   0.8383, 0.8322, 0.8448, 0.8469, 0.8467, 0.8461, 0.8460, 0.8398]

    # 30-epoch Video model training history (DeeperForensics)
    vid_train_loss = [1.2451, 0.9100, 0.8642, 0.8150, 0.6783, 0.6521, 0.6012, 0.6471, 0.5636, 0.5667, 
    ...
    vid_train_acc = [0.4894, 0.5266, 0.5160, 0.5585, 0.6064, 0.5851, 0.6809, 0.6596, 0.7553, 0.6968, 
                     0.7074, 0.6809, 0.7287, 0.7287, 0.7819, 0.7500, 0.7500, 0.7500, 0.7553, 0.7606, 
                     0.7713, 0.7819, 0.7606, 0.7766, 0.7234, 0.7819, 0.7766, 0.8138, 0.7766, 0.8085]
    vid_val_loss = [1.0327, 0.9071, 0.8237, 0.7673, 0.7272, 0.6983, 0.6913, 0.6696, 0.6575, 0.6641, 
    ...
    vid_val_acc = [0.4681, 0.5106, 0.5319, 0.4894, 0.5319, 0.5745, 0.5745, 0.5957, 0.5957, 0.5532, 
                   0.5745, 0.5957, 0.6170, 0.6383, 0.6383, 0.6383, 0.5957, 0.6383, 0.6600, 0.6170, 
                   0.6383, 0.6383, 0.6383, 0.6383, 0.6600, 0.6383, 0.6600, 0.6383, 0.6383, 0.6600]
    vid_val_f1 = [0.4898, 0.4889, 0.4211, 0.4000, 0.4762, 0.5000, 0.5652, 0.5581, 0.5581, 0.5116, 
                  0.5455, 0.5581, 0.5909, 0.6047, 0.6047, 0.6047, 0.5778, 0.6222, 0.6364, 0.5714, 
                  0.6047, 0.6047, 0.6047, 0.6047, 0.6364, 0.6047, 0.6364, 0.6047, 0.6047, 0.6364]

    # 80-epoch Multiclass model training history (Real vs Deepfake vs AI-Generated)
    multi_train_loss = [1.4029, 0.9395, 0.7973, 0.7004, 0.6472, 0.5793, 0.494, 0.4518, 0.3595, 0.329, 
                        0.2464, 0.2448, 0.2118, 0.1191, 0.1109, 0.0698, 0.0691, 0.0399, 0.0376, 0.0297, 
                        0.0272, 0.0186, 0.0178, 0.0205, 0.0531, 0.0166, 0.0138, 0.0128, 0.0554, 0.0159, 
                        0.012, 0.0333, 0.0103, 0.0128, 0.0312, 0.0206, 0.0116, 0.0095, 0.0095, 0.011, 
                        0.0096, 0.0074, 0.0248, 0.0103, 0.0086, 0.0078, 0.0116, 0.0086, 0.0089, 0.0128, 
                        0.2511, 0.1799, 0.1183, 0.0668, 0.0439, 0.0297, 0.0261, 0.0717, 0.0767, 0.0749, 
                        0.0376, 0.0612, 0.0448, 0.0334, 0.0235, 0.0156, 0.03, 0.0186, 0.023, 0.0097, 
                        0.009, 0.0158, 0.0171, 0.0109, 0.0084, 0.0071, 0.0084, 0.0154, 0.0054, 0.0075]
    multi_train_acc = [0.4098, 0.562, 0.6, 0.6424, 0.6793, 0.7109, 0.7837, 0.7989, 0.8652, 0.8913, 
                       0.9207, 0.9098, 0.9391, 0.9728, 0.9728, 0.9859, 0.9804, 0.9924, 0.9902, 0.9957, 
                       0.9967, 0.9978, 0.9978, 0.9989, 0.9891, 1.0, 0.9989, 0.9989, 0.9946, 1.0, 
                       0.9989, 0.9957, 1.0, 1.0, 0.9967, 0.9946, 0.9989, 1.0, 1.0, 0.9989, 
                       1.0, 1.0, 0.9978, 1.0, 0.9989, 1.0, 0.9989, 1.0, 1.0, 0.9989, 
                       0.9065, 0.9315, 0.9652, 0.9837, 0.9902, 0.9946, 0.9946, 0.9804, 0.9772, 0.9772, 
                       0.9902, 0.987, 0.988, 0.9891, 0.9935, 0.9946, 0.9935, 0.9946, 0.9924, 1.0, 
                       0.9989, 0.9946, 0.9967, 0.9989, 0.9989, 1.0, 0.9989, 0.9978, 1.0, 0.9978]
    multi_val_loss = [0.9772, 0.7817, 0.7073, 0.6874, 0.6767, 0.6511, 0.6249, 0.6352, 0.6356, 0.5977, 
                      0.6618, 0.6854, 0.6515, 0.8128, 0.8955, 0.6544, 0.7182, 0.6875, 0.7694, 0.7706, 
                      0.7848, 0.82, 0.7753, 0.8151, 0.7675, 0.7561, 0.7819, 0.7354, 0.7923, 0.8046, 
                      0.7693, 0.7328, 0.7852, 0.8031, 0.7598, 0.774, 0.8366, 0.7933, 0.8246, 0.7902, 
                      0.7856, 0.835, 0.8264, 0.8085, 0.8839, 0.825, 0.7799, 0.8859, 0.8151, 0.825, 
                      0.2422, 0.2487, 0.2761, 0.2659, 0.2921, 0.2695, 0.2937, 0.3973, 0.2911, 0.3222, 
                      0.2534, 0.2522, 0.3938, 0.289, 0.3038, 0.3226, 0.362, 0.3781, 0.3374, 0.3278, 
                      0.3323, 0.3389, 0.3457, 0.3312, 0.3137, 0.3264, 0.3139, 0.315, 0.331, 0.3203]
    multi_val_acc = [0.4826, 0.6174, 0.6348, 0.6348, 0.5826, 0.613, 0.6652, 0.6435, 0.6478, 0.6739, 
                     0.6826, 0.6522, 0.687, 0.6609, 0.6957, 0.6826, 0.713, 0.7087, 0.6783, 0.6609, 
                     0.6783, 0.6826, 0.6957, 0.6783, 0.687, 0.6913, 0.6826, 0.7043, 0.7000, 0.713, 
                     0.687, 0.7087, 0.6913, 0.6957, 0.7087, 0.7043, 0.6739, 0.6696, 0.6652, 0.6696, 
                     0.6826, 0.6652, 0.6739, 0.6783, 0.6652, 0.6783, 0.7087, 0.6739, 0.6739, 0.6696, 
                     0.8783, 0.887, 0.9087, 0.9043, 0.9043, 0.9000, 0.9087, 0.8783, 0.9000, 0.8913, 
                     0.9174, 0.9217, 0.8783, 0.9087, 0.9087, 0.8826, 0.8783, 0.8826, 0.887, 0.9000, 
                     0.8957, 0.9043, 0.9000, 0.8913, 0.887, 0.9043, 0.8913, 0.8957, 0.8957, 0.9087]
    multi_val_f1 = [0.3551, 0.6103, 0.6129, 0.6209, 0.5508, 0.6081, 0.6576, 0.6299, 0.6387, 0.6737, 
                    0.6804, 0.652, 0.6833, 0.6492, 0.6724, 0.6822, 0.713, 0.7071, 0.6731, 0.6545, 
                    0.6745, 0.6822, 0.6945, 0.6731, 0.6864, 0.6913, 0.6804, 0.7043, 0.6974, 0.7091, 
                    0.6858, 0.7085, 0.6896, 0.6907, 0.7083, 0.7029, 0.6682, 0.6664, 0.6594, 0.6679, 
                    0.6819, 0.661, 0.6698, 0.6767, 0.6565, 0.6751, 0.7085, 0.6644, 0.671, 0.665, 
                    0.8783, 0.887, 0.9079, 0.9044, 0.9045, 0.9001, 0.9088, 0.8775, 0.9001, 0.8913, 
                    0.9174, 0.9214, 0.8788, 0.9086, 0.9084, 0.8826, 0.8784, 0.8823, 0.8866, 0.9001, 
                    0.8957, 0.9039, 0.9000, 0.8915, 0.8869, 0.9045, 0.8913, 0.8955, 0.8958, 0.9088]
    ...
    cells = [
        ...
        # Cell 2: Setup & Configuration (Imports)
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
        ...
        # Cell 3: Image Model Architecture
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
        ...
        # Cell 4: Video Model Architecture (DeeperForensics)
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
        ...
        # Cell 5: Multi-Class Model Architecture (Track C)
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
        ...
        # Cell 6: Video Face Crops Extraction
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
        ...
        # Cell 8: Gorgeous Metrics & Graphing Visualizer
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
        ...
        },
        {
            ...
            "source": [
                ...
                "except:\n",
                "    img_history = {\n",
                "        \"train_loss\": " + str(img_train_loss) + ",\n",
                "        \"train_acc\": " + str(img_train_acc) + ",\n",
                "        \"val_loss\": " + str(img_val_loss) + ",\n",
                "        \"val_acc\": " + str(img_val_acc) + ",\n",
                "        \"val_f1\": " + str(img_val_f1) + ",\n",
                "        \"val_auc\": " + str(img_val_auc) + "\n",
                "    }\n",
                "\n",
                "try:\n",
                ...
                "except:\n",
                "    vid_history = {\n",
                "        \"train_loss\": " + str(vid_train_loss) + ",\n",
                "        \"train_acc\": " + str(vid_train_acc) + ",\n",
                "        \"val_loss\": " + str(vid_val_loss) + ",\n",
                "        \"val_acc\": " + str(vid_val_acc) + ",\n",
                "        \"val_f1\": " + str(vid_val_f1) + "\n",
                "    }\n",
                "\n",
                "try:\n",
                ...
                "except:\n",
                "    multi_history = {\n",
                "        \"train_loss\": " + str(multi_train_loss) + ",\n",
                "        \"train_acc\": " + str(multi_train_acc) + ",\n",
                "        \"val_loss\": " + str(multi_val_loss) + ",\n",
                "        \"val_acc\": " + str(multi_val_acc) + ",\n",
                "        \"val_f1\": " + str(multi_val_f1) + "\n",
                "    }\n",
                "\n",
    ...
    output_path = Path("models/Deepfake_Model_Training.ipynb")
